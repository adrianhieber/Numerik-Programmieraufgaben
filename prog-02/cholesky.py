...
def random_spd_matrix(N, delta=0.0):
...
print("Differenz zwischen A und der Cholesky-Zerlegung: " + str(diff))

print("Differenz zwischen A und der langsamen Cholesky-Zerlegung: " + str(diff))
...
print("Differenz zwischen LM und der Cholesky-Zerlegung: " + str(diff))
